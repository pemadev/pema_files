...
@section('title', '500 - Terjadi Kesalahan | PT PEMA')
...
<div class="min-h-[70vh] flex items-center justify-center px-4 sm:px-6 lg:px-8">
    <div class="text-center max-w-lg mx-auto">
        ...
        <p class="mt-4 text-lg text-gray-500 leading-relaxed font-sans">
            Maaf, terjadi kesalahan pada server. Silakan coba lagi<br class="hidden sm:inline">
            dalam beberapa saat. Tim teknis kami sedang menangani masalah ini.
        </p>
