...
">
    <x-admin.confirm-modal
        id="delete-confirm"
        title="Hapus Berita"
        message="Apakah Anda yakin ingin menghapus berita ini? Data yang sudah dihapus tidak dapat dikembalikan."
    ...
    <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
            <h3 class="text-lg font-heading font-semibold text-gray-900">Daftar Berita</h3>
            <p class="text-sm text-gray-500 mt-1">Kelola berita perusahaan</p>
        </div>
                        ...
                        <tr class="hover:bg-gray-50/50 transition-colors">
                            ...
                            <td class="px-5 py-4 text-right whitespace-nowrap">
                                <div class="flex items-center justify-end gap-2">
                                    ...
                                    <button type="button"
                                            x-on:click="deleteUrl = '{{ route('admin.berita.destroy', $news) }}'; $dispatch('open-confirm-modal', { id: 'delete-confirm' })"
                        ...
                        <tr>
                            <td colspan="6" class="px-5 py-12 text-center">
                                <div class="flex flex-col items-center gap-2">
                                    <i class="fi fi-rs-file-text text-4xl text-gray-300"></i>
