    ...
    <div class="bg-white rounded-2xl border border-gray-100 shadow-sm">
        ...
        <div class="px-6 py-4 border-b border-gray-100">
            <h4 class="font-heading font-semibold text-gray-900">
                {{ isset($news) ? 'Form Edit Berita' : 'Form Tambah Berita' }}
            </h4>
        </div>

        {{-- Form --}}
        <form action="{{ isset($news) ? route('admin.berita.update', $news) : route('admin.berita.store') }}"
              method="POST"
            ...
            <div>
                ...
                <trix-editor input="content" class="trix-content" placeholder="Masukkan konten berita..." x-show="!preview"
            ...
            <div>
                ...
                <p class="mt-1 text-xs text-gray-400 ml-7">
                    Jika tidak dicentang, berita akan disimpan sebagai draf.
                </p>
            </div>
