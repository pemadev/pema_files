        ...
        <div class="bg-white rounded-2xl border border-gray-100 shadow-sm">
            ...
            <div class="p-5 space-y-5">
                ...
                <div>
                    ...
                    placeholder="Contoh: Mendukung ketahanan pangan nasional melalui penyediaan pupuk bagi sektor pertanian..."
                    class="w-full px-4 py-2.5 rounded-xl border border-gray-200 focus:ring-2 focus:ring-pema-500/20 focus:border-pema-500 text-sm transition-all resize-none @error('caption') border-red-300 @enderror">{{ old('caption', $partner->caption) }}</textarea>
                    <p class="text-xs text-gray-400 mt-1">Deskripsi singkat tentang kerja sama dengan mitra ini.</p>
                    @error('caption')
